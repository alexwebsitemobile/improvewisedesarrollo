...
$(function () {
    ...
    $(window).scroll(function () {
        ...
        if (scroll >= 100) {
            logo.removeClass('show').addClass("hide").fadeIn();
            logoScroll.removeClass('hide').addClass("show").fadeIn();
            header.addClass("header-bg-white");
        } else {
            logo.removeClass('hide').addClass("show").fadeIn();
            logoScroll.removeClass("show").addClass('hide').fadeIn();
...
$('.button').click(function () {
    var $btn = $(this),
            $step = $btn.parents('.body-pop'),
            stepIndex = $step.index(),
            $pag = $('.body-pop span').eq(stepIndex);
...
$('.rerun-button').click(function () {
   $('.modal-body-step-2').removeClass('is-showing');
