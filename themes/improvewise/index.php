    ...
    <div class="container">
        <div class="row pdtb30">
            <div class="col-xs-12 text-center">
                <h1 class="title-blue-md">Blog</h1>
            </div>
        </div>
            ...
            <div class="col-md-offset-1 col-md-10">
                ...
                if (have_posts()) {
                    while (have_posts()) {
                        ...
                        ?>
                        <div class="row">
                            <div class="col-xs-12 mgb30">
                                <article class="thumbnail blog-box clearfix">
                                    <div class="col-xs-12 visible-xs block-image-xs">
                                    ...
                                    <div class="col-sm-8 col-xs-12 tg-verticalmiddle">
                                        <!-- detail -->
                                        <div class="caption detail">
                                            ...
                                            <p style="color: #939393;"><i class="fa fa-calendar" style="color: #939393;"></i> <?php echo get_the_date(); ?></p>
                                            <!-- paragraph -->
                                    ...
                                    <div class="col-sm-4 col-xs-6 hidden-xs tg-verticalmiddle">
                                        <?php if (has_post_thumbnail()) { ?>
                                            <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
                                                <?php the_post_thumbnail('full', array('class' => 'img-responsive pdtb15')); ?>
                                            </a>
