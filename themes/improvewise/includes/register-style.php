...
add_action( 'wp_enqueue_scripts', function () {
	...
	/* Bootstrap v3.3.5 */
	wp_register_style( 'bootstrap', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css', array(), '3.3.5' );
	/* Font Awesome v4.4.0 */
	wp_register_style( 'font-awesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', array(), '4.4.0' );
	/* Theme */
